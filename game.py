    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN and event.key == pygame.K_ESCAPE:
                return "menu"  # back to menu for now (simple)
        ...
        if state != "PLAYING":
            ...
            draw_text_outline(WIN, "Press ENTER to return to menu", FONT, WHITE, BLACK, center=(WIDTH//2, HEIGHT//2 + 90), outline_thickness=2)
